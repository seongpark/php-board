    ...
    <div class="container mt-5">
        ...
        <form action="edit_process.php?idx=<?php echo $bno; ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" required value="<?php echo $board['name']; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" name="pw" placeholder="비밀번호를 새로 설정할 수 있습니다." required>
            </div>
